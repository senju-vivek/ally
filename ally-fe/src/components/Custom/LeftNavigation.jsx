...
function LeftNav() {
  ...
  return (
    ...
    <div
      className={
        !showSlide
          ? "h-screen bg-black w-[300px] border-r border-white hidden lg:flex items-center justify-between p-2 text-white flex-col translate-x-0"
          : "hidden"
      }
    >
      ...
      <div className="h-[80%] w-full p-2 flex items-start justify-start flex-col overflow-hidden overflow-y-auto text-sm scroll my-2">
        ...
        >
          <span className="flex gap-2 items-center justify-center text-base">
            <FiMessageSquare />
            <span className="text-sm">What are issues with Call-Centers ?</span>
          </span>
        </span>
        <span
        ...
        >
          <span className="flex gap-2 items-center justify-center text-base">
            <FiMessageSquare />
            <span className="text-sm"> How to resolve Financial issues ?</span>
          </span>
        </span>
      </div>
      {/* bottom section  */}
